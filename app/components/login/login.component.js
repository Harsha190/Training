...
var LoginComponent = (function () {
    function LoginComponent(router, loginService, authenticationService, commonService) {
        this.router = router;
    ...
    LoginComponent.prototype.getUser = function (event) {
        ...
        this.loginService.authenticateUser(currentUser.name, currentUser.password)
            ...
            if (data.loginId == currentUser.name && data.password == currentUser.password) {
                ...
                _this.loggedInUser = JSON.parse(localStorage.getItem('currUser'));
                _this.commonService.setName(currentUser.name);
                _this.commonService.setUserId(_this.loggedInUser.id);
                _this.authenticationService.isLoggedIn();
